...
**Built — open**
- 🧠 **[product-skill](https://github.com/gtm-k/product-skill)** ⭐ — 30+ PM frameworks as an AI skill: role-calibrated APM→CPO advice, confidence calibration, built-in blind-spot checks. One paste into ChatGPT, Claude, or Gemini. *Product judgment, on tap.*
- 📊 **[fintree](https://github.com/gtm-k/fintree)** — A 234-node, XBRL-mapped US GAAP P&L ontology for FP&A teams and AI agents.
- ⚛️ **[quantum-fusion-poc](https://github.com/gtm-k/quantum-fusion-poc)** — VQE on tungsten–hydrogen binding, validated on real IBM Quantum hardware. A frontier proof-of-concept — including what doesn't work yet.
